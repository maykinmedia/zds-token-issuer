...
"use strict";
__webpack_require__(128);__webpack_require__(330);__webpack_require__(336);
...
"use strict";
__webpack_require__(331);__webpack_require__(334);
...
"use strict";
var _bem=__webpack_require__(125);var _bem2=_interopRequireDefault(_bem);var _clipboard=__webpack_require__(333);var _clipboard2=_interopRequireDefault(_clipboard);function _interopRequireDefault(obj){return obj&&obj.__esModule?obj:{default:obj};}function _toConsumableArray(arr){if(Array.isArray(arr)){for(var i=0,arr2=Array(arr.length);i<arr.length;i++){arr2[i]=arr[i];}return arr2;}else{return Array.from(arr);}}function _classCallCheck(instance,Constructor){if(!(instance instanceof Constructor)){throw new TypeError("Cannot call a class as a function");}}var BLOCK_COPY='copy';var ELEMENT_BUTTON='button';var COPIES=_bem2.default.getBEMNodes(BLOCK_COPY);var Copy=function Copy(node){_classCallCheck(this,Copy);this.node=node;this.button=_bem2.default.getChildBEMNode(this.node,BLOCK_COPY,ELEMENT_BUTTON);new _clipboard2.default(this.button);};[].concat(_toConsumableArray(COPIES)).forEach(function(copy){return new Copy(copy);});
...
"use strict";
var _createClass=function(){function defineProperties(target,props){for(var i=0;i<props.length;i++){var descriptor=props[i];descriptor.enumerable=descriptor.enumerable||false;descriptor.configurable=true;if("value"in descriptor)descriptor.writable=true;Object.defineProperty(target,descriptor.key,descriptor);}}return function(Constructor,protoProps,staticProps){if(protoProps)defineProperties(Constructor.prototype,protoProps);if(staticProps)defineProperties(Constructor,staticProps);return Constructor;};}();var _bem=__webpack_require__(125);var _bem2=_interopRequireDefault(_bem);function _interopRequireDefault(obj){return obj&&obj.__esModule?obj:{default:obj};}function _toConsumableArray(arr){if(Array.isArray(arr)){for(var i=0,arr2=Array(arr.length);i<arr.length;i++){arr2[i]=arr[i];}return arr2;}else{return Array.from(arr);}}function _classCallCheck(instance,Constructor){if(!(instance instanceof Constructor)){throw new TypeError("Cannot call a class as a function");}}var BLOCK_JWT_FORMATTER='jwt-formatter';var JWT_FORMATTERS=_bem2.default.getBEMNodes(BLOCK_JWT_FORMATTER);var ELEMENT_PART='part';var MODIFIER_HEADER='header';var MODIFIER_PAYLOAD='payload';var MODIFIER_SIGNATURE='signature';var REGEXP_MATCH_JWT=/([a-zA-Z0-9\-_]+?)\.([a-zA-Z0-9\-_]+?)\.([a-zA-Z0-9\-_]+)?/;var JWTFormatter=function(){function JWTFormatter(node){_classCallCheck(this,JWTFormatter);this.node=node;this.format();}_createClass(JWTFormatter,[{key:'format',value:function format(){this.node.innerHTML=this.node.innerHTML.replace(REGEXP_MATCH_JWT,this.process.bind(this));}},{key:'process',value:function process(match,group1,group2,group3){var classNamePart1=_bem2.default.getBEMClassName(BLOCK_JWT_FORMATTER,ELEMENT_PART,MODIFIER_HEADER);var classNamePart2=_bem2.default.getBEMClassName(BLOCK_JWT_FORMATTER,ELEMENT_PART,MODIFIER_PAYLOAD);var classNamePart3=_bem2.default.getBEMClassName(BLOCK_JWT_FORMATTER,ELEMENT_PART,MODIFIER_SIGNATURE);return'<span class="'+classNamePart1+'">'+group1+'</span>.<span class="'+classNamePart2+'">'+group2+'</span>.<span class="'+classNamePart3+'">'+group3+'</span>';}}]);return JWTFormatter;}();[].concat(_toConsumableArray(JWT_FORMATTERS)).forEach(function(jwtFormatter){return new JWTFormatter(jwtFormatter);});
...
/***/ })
/******/ ]);
//# sourceMappingURL=token_issuer.js.map